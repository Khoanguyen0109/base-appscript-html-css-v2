...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"PvL2":[function(require,module,exports) {
var define;
      ...
      s = _l = function l() {
        ...
        switch (_typeof(s)) {
          ...
          case "object":
            ...
            break;
          default:
            return c.logStr('Unexpected type of argument! Expected "string" or "object", got ' + _typeof(s)), !1;
        }
        g["default"](i), d.fixVerticalPosition(), d.openModal(arguments[1]);
        for (var v = d.getModal(), h = v.querySelectorAll("button"), b = ["onclick", "onmouseover", "onmouseout", "onmousedown", "onmouseup", "onfocus"], w = function w(e) {
