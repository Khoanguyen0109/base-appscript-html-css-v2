...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"vjgY":[function(require,module,exports) {
...
function _check_login() {
  _check_login = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var user, password, check_user;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          user = $("#user_name").val();
          password = $("#password").val();
          check_user = info_user.filter(function (e) {
            if (user.toLowerCase().trim() === e[2].toLowerCase().trim() && password.toLowerCase().trim() === e[3].toLowerCase().trim() && e[10] == "Đang làm việc") {
